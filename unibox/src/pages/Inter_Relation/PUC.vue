<template>
  <div id="app_bg">
    <b-container>
      <div id="uni_name" class="py-5 ml-5 text-center" style="z-index:2">Pannasastra University of Cambodia (PUC)</div>
    </b-container>
...
export default {
    ...
    async created(){
      try{
        this.majors = await PostService.getUniversity("International Relation","Pannasastra University of Cambodia (PUC)",0);
      }catch(err){
