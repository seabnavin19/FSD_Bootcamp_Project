<template>
  <div id="app_bg">
    <b-container>
      <div id="uni_name" class="py-5 ml-5 text-center" style="z-index:2">National Institute of Posts, Telecommunications and ICT(NIPTICT)</div>
    </b-container>
...
export default {
    ...
    async created(){
      try{
        this.majors = await PostService.getUniversity("Computer Science","National Institute of Posts, Telecommunications and ICT(NIPTICT)",1);
      }catch(err){
