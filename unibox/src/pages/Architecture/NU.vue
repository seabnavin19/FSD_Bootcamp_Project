<template>
  <div id="app_bg">
    <b-container>
      <div id="uni_name" class="py-5 ml-5 text-center" style="z-index:2">Norton University (NU)</div>
    </b-container>
...
export default {
    ...
    async created(){
      try{
        this.majors = await PostService.getUniversity("Architecture","Norton University (NU)",3);
      }catch(err){
