<template>
  <div id="app_bg">
    <b-container>
      <div id="uni_name" class="py-5 ml-5 text-center" style="z-index:2">American University of Phnom Penh (AUPP)</div>
    </b-container>
...
export default {
    ...
    async created(){
      try{
        this.majors = await PostService.getUniversity("Architecture","American University of Phnom Penh (AUPP)",1);
      }catch(err){
